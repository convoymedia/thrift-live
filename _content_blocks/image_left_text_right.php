<div class="text_left_image_right <?php if (get_sub_field("include_speech_box")) { ?>sbox<?php } ?>" style="background-color:<?php the_sub_field("colour") ?>;<?php if (get_sub_field("add_2nd_colour")) { ?>padding-bottom:27px;<?php } ?>">
 <div class="block">
    <?php
